...
獅尾蝙蝠圓體基於[思源黑體](https://github.com/adobe-fonts/source-han-sans)筆觸長耳朵和拔腳改造，更加簡明現代化的字體。支援简体中文、繁體中文、韓文與日文；可以免費商用，歡迎大家自由應用、自由優化、自由改作！
...
### 「CJK TC」和「CJK SC」的比較：
![TC和SC比較](https://github.com/max32002/swei-bat-sans/raw/master/preview/compare_tc_sc.png)
...
### 「CJK TC」和「CJK JP」的比較：
![TC和SC比較](https://github.com/max32002/swei-bat-sans/raw/master/preview/compare_tc_jp.png)
...
## 更新日誌
[點擊此處](https://github.com/max32002/swei-bat-sans/blob/master/change_log.md) 查看更新記錄。
...
```
@font-face {
  font-family: 'SweiBatSansCJKtc-Regular';
  src: url(https://cdn.jsdelivr.net/gh/max32002/swei-bat-sans@2.0/WebFont/CJK%20TC/SweiBatSansCJKtc-Regular.woff2) format("woff2")
  , url(https://cdn.jsdelivr.net/gh/max32002/swei-bat-sans@2.0/WebFont/CJK%20TC/SweiBatSansCJKtc-Regular.woff) format("woff");
}
```
